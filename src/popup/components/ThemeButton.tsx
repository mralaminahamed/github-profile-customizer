...
export const ThemeButton: React.FC<ThemeButtonProps> = ({ theme, isActive, onClick }) => (
  ...
  >
    ...
    <div className="w-full h-full rounded-md overflow-hidden">
      {/* Header */}
      <div className="h-1/4 w-full" style={{ backgroundColor: theme.accentColor }} />
      {/* Content */}
      <div className="p-1 space-y-1">
        <div className="w-3/4 h-1 rounded-full" style={{ backgroundColor: theme.border }} />
        <div className="w-1/2 h-1 rounded-full" style={{ backgroundColor: theme.border }} />
      </div>
    </div>
